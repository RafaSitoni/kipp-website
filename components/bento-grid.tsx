...
const features = [
  {
    ...
    description: "Atendimento sem pausas, todos os dias",
    accent: "#2563EB",
  },
  {
    icon: Flame,
    title: "Zero",
    subtitle: "Equipe Necessária",
    description: "Automatize sem precisar de mais funcionários",
    accent: "#FF6B35",
  },
  {
    icon: Brain,
    ...
    description: "Sempre disponível para seus clientes",
    accent: "#00D4FF",
  },
  {
    icon: Sparkles,
    ...
    description: "Cresça sem limites de volume",
    accent: "#2563EB",
  },
]
  ...
  return (
    <section id="formula" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#2563EB] text-[10px] tracking-[0.3em] uppercase"
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#2563EB] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
